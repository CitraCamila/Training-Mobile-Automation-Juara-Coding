...
Mobile.setText(findTestObject('android.widget.EditText Keterangan'), 'Sisa Gaji Bulan Lalu', 0)
...
txtket = Mobile.getText(findTestObject('android.widget.TextView - Sisa Gaji Bulan Lalu'), 0)

System.out.println(txtket)

Mobile.verifyElementText(findTestObject('android.widget.TextView - Sisa Gaji Bulan Lalu'), txtket)
