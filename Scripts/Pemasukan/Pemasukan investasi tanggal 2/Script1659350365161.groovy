...
Mobile.setText(findTestObject('android.widget.EditText Keterangan'), 'Saham', 0)
...
txtket = Mobile.getText(findTestObject('android.widget.TextView - Saham'), 0)

System.out.println(txtket)

Mobile.verifyElementText(findTestObject('android.widget.TextView - Saham'), txtket)
