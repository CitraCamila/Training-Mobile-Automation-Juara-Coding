...
Mobile.tap(findTestObject('android.widget.TextView - Kategori Gaji'), 0)

Mobile.setText(findTestObject('android.widget.EditText Jumlah'), '1000000', 0)

Mobile.setText(findTestObject('android.widget.EditText Keterangan'), 'Gaji Bulan Agustus', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - SIMPAN'), 0)

txtkategori = Mobile.getText(findTestObject('android.widget.TextView - Gaji'), 0)

Mobile.verifyElementText(findTestObject('android.widget.TextView - Gaji'), txtkategori)

txtket = Mobile.getText(findTestObject('android.widget.TextView - Gaji Bulan Agustus'), 0)

System.out.println(txtket)

Mobile.verifyElementText(findTestObject('android.widget.TextView - Gaji Bulan Agustus'), txtket)
