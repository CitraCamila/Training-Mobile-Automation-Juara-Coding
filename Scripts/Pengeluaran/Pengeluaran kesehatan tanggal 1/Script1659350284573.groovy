...
Mobile.setText(findTestObject('android.widget.EditText Jumlah'), '100000', 0)

Mobile.setText(findTestObject('android.widget.EditText Keterangan'), 'Obat', 0)
...
txtket = Mobile.getText(findTestObject('android.widget.TextView - Obat'), 0)

System.out.println(txtket)

Mobile.verifyElementText(findTestObject('android.widget.TextView - Obat'), txtket)
