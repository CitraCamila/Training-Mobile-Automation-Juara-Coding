...
Mobile.tap(findTestObject('android.widget.TextView - Kategori Kesehatan'), 0)

Mobile.setText(findTestObject('android.widget.EditText Jumlah'), '300000', 0)

Mobile.setText(findTestObject('android.widget.EditText Keterangan'), 'Dokter', 0)
...
txtkategori = Mobile.getText(findTestObject('android.widget.TextView - Kesehatan'), 0)

Mobile.verifyElementText(findTestObject('android.widget.TextView - Kesehatan'), txtkategori)

txtket = Mobile.getText(findTestObject('android.widget.TextView - Dokter'), 0)

System.out.println(txtket)

Mobile.verifyElementText(findTestObject('android.widget.TextView - Dokter'), txtket)
