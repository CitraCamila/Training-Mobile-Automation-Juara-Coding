...
Mobile.setText(findTestObject('android.widget.EditText Jumlah'), '200000', 0)

Mobile.setText(findTestObject('android.widget.EditText Keterangan'), 'Warteg', 0)
...
txtket = Mobile.getText(findTestObject('android.widget.TextView - Warteg'), 0)

System.out.println(txtket)

Mobile.verifyElementText(findTestObject('android.widget.TextView - Warteg'), txtket)
